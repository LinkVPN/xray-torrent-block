...
var (
	DefaultMessageTemplate = `⚠️ <b>Замечено использование торрентов!</b>
...
<b>Через %d минут вас разблокирует</b>, но если вы продолжите качать торренты, вас снова заблокирует и вы получите данное сообщение снова.`
